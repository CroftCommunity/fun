...
export const REGISTRY: readonly GameEntry[] = [
  ...
  { id: "drop4", title: "Drop 4", icon: "🔴", status: "playable", group: "versus", load: drop4Module },
  { id: "othello", title: "Othello", icon: "⚫", status: "playable", cover: true, group: "versus", load: othelloModule },
  { id: "checkers", title: "Checkers", icon: "⛃", status: "playable", group: "versus", load: checkersModule },
  { id: "dots", title: "Dots and Boxes", icon: "▦", status: "playable", group: "versus", load: dotsModule },
  { id: "furrow", title: "Furrow", icon: "🌾", status: "playable", group: "versus", load: furrowModule },
