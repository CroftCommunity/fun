      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            "On a phone, use the pad under the board — two thumb clusters: left and right to move with Hold beneath them under your left thumb; the two rotates with soft-drop and hard-drop under your right. The buttons give a little buzz when pressed.",
            "The well itself listens too: tap it to rotate, flick down to hard-drop, flick sideways to move one cell. Settings → On-screen controls (Auto / On / Off) shows or hides the pad; Auto shows it on a touch screen.",
