...
(Track B / B3). Builds on B0 (`plans/2026-07-30-trio-tumble-b0-specials.md`, a colour
...
- `crates/trio-tumble-core/RULES.md` — extend **T1c — Activation** with the colour bomb:
...
- `crates/trio-tumble-core/vectors/README.md` — note the colour-bomb vector (swap →
  clear-all-of-a-colour at step 0).
- `TODO/trio-tumble.md` + roadmap Track B — tick B3.
...
**Read/Write-set:** engine.rs, RULES.md, tests, vectors/13, games/trio-tumble/*.json.
