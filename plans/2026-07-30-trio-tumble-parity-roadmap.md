...
**Status:** planning (2026-07-30). Builds on `plans/2026-07-30-trio-tumble-followups.md`
...
`docs/BUILDING-GAMES.md`; core rules: `crates/trio-tumble-core/RULES.md`.
...
1. **Reuse the proven mode template** for every new objective (this is exactly the
   ...
   `trio-tumble-solver`-style solver + committed winnable-daily pack → a mode-aware
...
- **A2 solver + pack:** a `find_dejelly`-style budgeted search + a committed
  winnable-daily jelly pack (mirror `trio-tumble-solver`), regeneration drill.
- **A3 binding:** `Mode::Jelly`, `new_jelly_game`, a `TrioTumbleJelly` outcome kind
  (`trio-tumble-jelly`), `board_view` jelly mask + jelly-remaining/total.
...
- **Design (decided 2026-07-30):**
  ...
  - **No version bump** (D5, no users): change par in place; `TrioTumble::VERSION`
    stays 1.
- **Build increments:** (1) `par_tiers` ladder in `trio-tumble-solver` + rung tests;
...
Execution plan for B0: `plans/2026-07-30-trio-tumble-b0-specials.md`.
...
- **B1 striped — DONE (2026-07-30)** (plan: `plans/2026-07-30-trio-tumble-b1-striped.md`).
...
- **B2 wrapped — DONE (2026-07-31)** (plan: `plans/2026-07-30-trio-tumble-b2-wrapped.md`).
  ...
  `state_hash`).
- **B3 colour bomb — DONE (2026-07-31)** (plan: `plans/2026-07-30-trio-tumble-b3-colorbomb.md`).
...
- **B4 fish (2×2 square) — DONE (2026-07-31)** (plan: `plans/2026-07-30-trio-tumble-b4-fish.md`).
...
- **B5 combos — DONE (2026-07-31)** (plan: `plans/2026-07-30-trio-tumble-b5-combos.md`).
...
- **B5.4 fish combos — DONE (2026-07-31)** (plan: `plans/2026-07-31-trio-tumble-b5.4-fish-combos.md`).
...
- **B6 solver + winnability + par for specials — DONE (2026-07-31)** (plan:
  `plans/2026-07-30-trio-tumble-b6-specials-par.md`). Phase-0 discovery found the
...
- **C1 player ladder + par table — DONE** (Track P-now + B6): 1★ random / 2★ greedy /
  3★ specials-exploiting beam, baked into `games/trio-tumble/par-pack.json` (embedded), with
  the byte-identical regeneration drill.
- **C2 offline calibration study — DONE** (note: `plans/2026-07-31-trio-tumble-c2-calibration.md`).
...
- **Objectives — DONE.**
  - **Ingredients (drop-to-bottom)** — DONE (plan `plans/2026-07-31-trio-tumble-d-ingredients.md`):
    `Cell::Ingredient`, a falling non-gem exiting the bottom row (hash tag `0x03`).
  - **Order/mixed CHECKLIST** — DONE (plan `plans/2026-07-31-trio-tumble-d-checklist-obstacles.md`):
    ...
    (seed-template + solver-filtered pack), verifiable (`trio-tumble-checklist`), accessible,
...
- **Obstacle families — DONE (meringue + licorice).** DONE (same plan): licorice + meringue
  ...
  Winnable-daily + verifiable (`trio-tumble-obstacles`), deployed + live-smoked. **Further families
...
keep `TODO/trio-tumble.md`, plan headers, `RULES.md`, `docs/BUILDING-GAMES.md` in sync;
