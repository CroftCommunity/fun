...
**Status:** planning (2026-07-31). Parent: `plans/2026-07-30-match3-b5-combos.md`
...
- `TODO/match3.md` + roadmap Track B — note fish combos done (the last combo gap).
- `src/games/match3-howto.ts` — a line on fish combos.
...
- [ ] roadmap + `TODO/match3.md`; regenerate guide shots if visual (no new badge — none
