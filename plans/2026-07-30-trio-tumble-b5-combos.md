...
- `crates/trio-tumble-core/RULES.md` — a new **T1d — Combos (special + special by swap)**
...
- `crates/trio-tumble-core/vectors/README.md` — the combo vectors (15+) and the "swap two
  pre-placed specials" authoring shape.
- `TODO/trio-tumble.md` + roadmap Track B — tick B5.
- `src/games/trio-tumble-howto.ts` + `docs/BUILDING-GAMES.md` — a combo how-to entry; note the
