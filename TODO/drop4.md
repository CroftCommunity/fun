...
longer carries its own `select_in_band`/`LiveBand`), then **chess** (**shipped
2026-08-30** as a build-fresh core verified by perft, our own Oracle, no hosting
gate — `plans/2026-08-30-plan-chess-vs-engine.md` and `TODO/chess.md` supersede
the vetted-move-gen + Stockfish note that stood here).
