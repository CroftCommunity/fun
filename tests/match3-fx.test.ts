//! Unit tests for match-3's presentation-layer pure logic: the cascade analyser
...
import { analyzeCascade, celebrationTier } from "../src/games/match3-fx.js";
import { createBus, type M3Event } from "../src/games/match3-events.js";
