...
describe("games drawer chrome", () => {
  ...
  it("lists every registry game as a link to its own URL", () => {
    ...
    expect(ids).toEqual(["placeholder", "solitaire", "match3", "bubble", "wyrdle", "2048", "drop4", "othello", "align", "blockdoku", "looseends", "color-sort", "astray", "hexgl", "clumsybird", "orchard-drop", "cribbage"]);
    expect(
