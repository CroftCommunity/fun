...
describe("games drawer chrome", () => {
  ...
  it("lists every registry game as a link to its own URL", () => {
    ...
    expect(ids).toEqual(["solitaire", "trio-tumble", "bubble", "wyrdle", "2048", "drop4", "othello", "checkers", "dots", "furrow", "align", "blockdoku", "looseends", "mahjong", "color-sort", "orchard-drop", "cribbage", "chess", "placeholder"]);
    expect(
