...
// How-to-play screenshots (regenerated by `npm run guide:shots`).
const guideAssets = join(root, "assets", "guide");
if (await exists(guideAssets)) await cp(guideAssets, join(dist, "assets", "guide"), { recursive: true });
