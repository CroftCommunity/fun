...
mod tests {
    ...
    const GOLDEN_COUNTS: [i32; 100] = [
        10, 11, 11, 12, 11, 13, 13, 13, 12, 14, 14, 15, 14, 15, 16, 19, 17, 18, 19, 18, 18, 18, 21,
        20, 20, 20, 21, 23, 22, 23, 25, 25, 25, 24, 27, 26, 26, 27, 27, 27, 30, 28, 31, 30, 28, 29,
        33, 32, 35, 31, 32, 29, 31, 31, 33, 36, 33, 37, 36, 36, 38, 35, 40, 37, 39, 38, 38, 42, 38,
        39, 40, 47, 41, 39, 46, 39, 43, 46, 41, 44, 48, 48, 44, 47, 48, 46, 48, 55, 49, 48, 50, 51,
        56, 51, 49, 51, 58, 51, 52, 54,
    ];
