...
use trio_tumble_core::board::{Board, Cell};
use trio_tumble_core::engine::Game;
use trio_tumble_core::Pos;
...
fn cleared_set(report: &trio_tumble_core::MoveReport) -> BTreeSet<Pos> {
