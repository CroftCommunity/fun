...
use trio_tumble_core::vectors::Vector;

fn vectors_dir() -> PathBuf {
    // Self-contained crate: vectors travel inside crates/trio-tumble-core/vectors
    // (promoted from the discovery trio-tumble-p1 experiment, 2026-07-28).
