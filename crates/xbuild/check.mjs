...
const [wasmPath, vectorsDir, dotsVectorsDir, furrowVectorsDir, orchardVectorsDir] =
  process.argv.slice(2);
if (!wasmPath || !vectorsDir || !dotsVectorsDir || !furrowVectorsDir || !orchardVectorsDir) {
  console.error(
    "usage: node check.mjs <xbuild.wasm> <solitaire-vectors-dir> <dots-vectors-dir> <furrow-vectors-dir> <orchard-vectors-dir>",
  );
  process.exit(2);
}
