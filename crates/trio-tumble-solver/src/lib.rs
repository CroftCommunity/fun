//! Build-time win-objective solver + winnable-daily-pack generator for Trio Tumble.
//!
//! A shared **budgeted** depth-first [`search`] over [`trio_tumble_core`] with
...
/// Serialize a blockers pack (`kind = "trio-tumble-blockers-pack"`, v1).
///
/// # Errors
...
pub fn pack_to_doc(pack: &Pack) -> Result<Vec<u8>, pond_docformat::DocError> {
    write_pack(pack, "trio-tumble-blockers-pack")
}

/// Serialize a jelly pack (`kind = "trio-tumble-jelly-pack"`, v1).
///
/// # Errors
/// Propagates [`pond_docformat::DocError`] on a serialization failure.
pub fn jelly_pack_to_doc(pack: &Pack) -> Result<Vec<u8>, pond_docformat::DocError> {
    write_pack(pack, "trio-tumble-jelly-pack")
}

/// Serialize an ingredients pack (`kind = "trio-tumble-ingredients-pack"`, v1).
///
/// # Errors
/// Propagates [`pond_docformat::DocError`] on a serialization failure.
pub fn ingredients_pack_to_doc(pack: &Pack) -> Result<Vec<u8>, pond_docformat::DocError> {
    write_pack(pack, "trio-tumble-ingredients-pack")
}

/// Serialize a checklist pack (`kind = "trio-tumble-checklist-pack"`, v1).
///
/// # Errors
/// Propagates [`pond_docformat::DocError`] on a serialization failure.
pub fn checklist_pack_to_doc(pack: &Pack) -> Result<Vec<u8>, pond_docformat::DocError> {
    write_pack(pack, "trio-tumble-checklist-pack")
}

/// Serialize an obstacles pack (`kind = "trio-tumble-obstacles-pack"`, v1).
///
/// # Errors
/// Propagates [`pond_docformat::DocError`] on a serialization failure.
pub fn obstacles_pack_to_doc(pack: &Pack) -> Result<Vec<u8>, pond_docformat::DocError> {
    write_pack(pack, "trio-tumble-obstacles-pack")
}
...
/// Serialize the par table (`kind = "trio-tumble-par-pack"`, v1).
///
/// # Errors
/// Propagates [`pond_docformat::DocError`] on a serialization failure.
pub fn par_pack_to_doc(pack: &ParPack) -> Result<Vec<u8>, pond_docformat::DocError> {
    pond_docformat::write("trio-tumble-par-pack", 1, pack)
}
