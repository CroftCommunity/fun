...
| `g-looseends-mechanic.html` | **Mock G — Loose Ends, the knot has a key** (2026-09-08, v1). The research pass mock F's Q10 parked, drawn once: locks (an arrow that stays put until the arrow tied to it has gone) as the second mechanic, colour bands parked with the reason, the par already the star rule. One sketch, five decisions, nothing built; plan `plans/2026-09-08-plan-looseends-mechanic.md`. Captures in `snaps/g-looseends-mechanic/` |
